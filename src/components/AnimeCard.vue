<template>
  <div class="anime-card bg-white rounded-xl shadow-lg overflow-hidden border-l-4 max-w-2xl mx-auto dark:bg-gray-800 dark:shadow-2xl" :style="{ borderLeftColor: anime.color || '#cccccc' }">
    ...
    <div class="highlights p-6 space-y-4">
      <div
        ...
        :key="hIndex"
        class="highlight-item space-y-2 dark:border-gray-700"
      >
        <div class="text-center space-y-1">
          ...
          <div v-else class="text-gray-500 italic text-sm dark:text-gray-400">
          ...
          >
            <div class="flex-1 text-right">
              ...
              <p
                ...
                class="inline-block bg-blue-50 text-blue-600 text-sm italic px-3 py-2 rounded-lg shadow-sm border border-blue-200 text-right dark:bg-blue-900 dark:text-blue-300 dark:border-blue-800"
              >
...
<script setup>
// (Phần script và style không thay đổi)
import { ref } from 'vue';
